...
export default function LoadingSpinner({ text, fullScreen = false }: LoadingSpinnerProps) {
  // Non-fullscreen: simple inline spinner for tables/sections
  if (!fullScreen) {
    return (
      <div className="w-full min-h-[300px] flex items-center justify-center">
        <div className="flex flex-col items-center justify-center p-8 space-y-6">
          ...
          <p className="text-[10px] sm:text-xs md:text-sm font-black tracking-[0.2em] text-red-600 uppercase text-center max-w-[80vw]">
            {text || 'MEMUAT DATA...'}
          </p>
        </div>
      </div>
  ...
  // FullScreen: Premium splash/launch screen
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden splash-screen">
      {/* Background */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6">
        ...
        <div className="relative splash-logo">
          ...
          {/* Logo container — large enough to never clip */}
        ...
        <div className="mt-8 text-center splash-text">
          ...
          <p className="text-red-200/60 text-[10px] sm:text-xs font-bold tracking-[0.25em] uppercase mt-3">
            PAC Kawunganten
          </p>
        </div>

        {/* Premium Loading Animation */}
        <div className="mt-10 flex flex-col items-center splash-loader">
          {/* Orbital rings */}
          ...
          {/* Status text */}
          {text && (
            <p className="text-red-200/50 text-[9px] sm:text-[10px] font-bold tracking-[0.2em] uppercase mt-4 text-center">
              {text}
            </p>
          )}
        </div>
